...
/****************************************************************
    ...
    Others:
****************************************************************/
__FUNCTION_HEADER__ void BiToW(unsigned int Bi[], unsigned int W[])
{
    int i;
    unsigned int tmp;
    for (i = 0; i <= 15; i++)
...
/*****************************************************************
    ...
    Others:
*****************************************************************/
__FUNCTION_HEADER__ void WToW1(unsigned int W[], unsigned int W1[])
{
    int i;
    for (i = 0; i <= 63; i++)
    {
...
/******************************************************************
    ...
    Others:
********************************************************************/
__FUNCTION_HEADER__ void CF(unsigned int W[], unsigned int W1[], unsigned int V[])
{
    unsigned int SS1;
    unsigned int SS2;
    unsigned int TT1;
...
*******************************************************************************/
__FUNCTION_HEADER__ void BigEndian(unsigned char src[], unsigned int bytelen, unsigned char des[])
{
    unsigned char tmp = 0;
    unsigned int i = 0;
...
/******************************************************************************
    ...
    Others:
*******************************************************************************/
__FUNCTION_HEADER__ void SM3_init(SM3_STATE *md)
{
...
/******************************************************************************
    ...
    Others:
*******************************************************************************/
__FUNCTION_HEADER__ void SM3_compress(SM3_STATE *md)
{
    unsigned int W[68];
    unsigned int W1[64];
...
/******************************************************************************
    ...
    Others:
*******************************************************************************/
__FUNCTION_HEADER__ void SM3_process(SM3_STATE *md, unsigned char *buf, int len)
{
    while (len--)
    {
        /* copy byte */
...
/******************************************************************************
    ...
    Others:
*******************************************************************************/
__FUNCTION_HEADER__ void SM3_done(SM3_STATE *md, unsigned char hash[])
{
    int i;
    unsigned char tmp = 0;
...
/******************************************************************************
    ...
    Others:
*******************************************************************************/
__FUNCTION_HEADER__ void SM3_256(unsigned char buf[], int len, unsigned char hash[])
{
    SM3_STATE md;
    SM3_init(&md);
...
Others:
*******************************************************************************/
__FUNCTION_HEADER__ void SM3_KDF(unsigned char Z[], unsigned short zlen, unsigned short klen, unsigned char K[])
{
